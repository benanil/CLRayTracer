...
struct Camera
{
	...
	: viewportSize(xviewPortSize), position(55.0f, 0.0f, 55.0f), targetPosition(55.0f,0.0f,55.0f), Front(0.0f,0.0f,1.0f)
	{
	...
	void Update()
	{
		...
		float speed = dt * (1.0f + Window::GetKey(KeyCode_LEFT_SHIFT) * 2.0f) * 5.0f;
