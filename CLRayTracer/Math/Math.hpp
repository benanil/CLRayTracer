...
template<typename T> FINLINE constexpr T Max(const T a, const T b) { return a > b ? a : b; }
template<typename T> FINLINE constexpr T Min(const T a, const T b) { return a < b ? a : b; }
